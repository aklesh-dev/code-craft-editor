  ...
  return (
    <section className="relative z-10">
      ...
      >
        ...
        {/* Actions. Theme selector access to all users, language selector only for pro users */}
        <div className="flex items-center gap-4">
          ...
          {/* Pro Btn, show only if user is not pro feature user */}
          {!convexUser?.isPro && (
            <Link
              href="/pricing"
          ...
          {/* Run btn component, show only if user is signed in */}
          <SignedIn>
            <RunButton />
          </SignedIn>

          {/* Profile btn component, show only if user is signed in */}
