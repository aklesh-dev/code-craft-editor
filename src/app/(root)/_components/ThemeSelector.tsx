...
function ThemeSelector() {
  ...
  // *Ensure the component only renders on the client side to avoid theme discrepancies between server and client
  useEffect(() => {
    setMounted(true);
  }, []);

  if (!mounted) return null; // *Skip rendering until the component is mounted on the client side
